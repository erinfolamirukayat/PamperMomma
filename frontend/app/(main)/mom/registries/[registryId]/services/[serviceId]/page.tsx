...
import { ServiceContributionFormModal, ServiceContributionsCard, ServiceDetailsCard, ServiceHero, ServiceQuickStatCard, ServiceTimelineCard } from '@/components/service'
...
function Page() {
    ...
    const {
        dispatch: goService,
        data: serviceData
    } = useHulkFetch<Service>(`/registries/services/${serviceId}`)
